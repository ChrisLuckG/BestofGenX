      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl border border-warm p-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-full bg-[#E36B11]/10 flex items-center justify-center flex-shrink-0">
                <Heart className="w-5 h-5 text-[#E36B11]" />
              </div>
              <div>
            ...
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-full bg-[#E36B11]/10 flex items-center justify-center flex-shrink-0">
                <Zap className="w-5 h-5 text-[#E36B11]" />
              </div>
              <div>
        ...
        <div className="bg-white rounded-2xl border border-warm p-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-[#E36B11]/5 rounded-xl border border-[#E36B11]/20">
              <div className="flex items-center gap-2 mb-2">
                <Gamepad2 className="w-5 h-5 text-[#E36B11]" />
              ...
              <span className="text-xs text-[#E36B11] font-medium">Freelance · Remote</span>
            </div>
            ...
            <div className="p-4 bg-[#E36B11]/5 rounded-xl border border-[#E36B11]/20">
              ...
              <span className="text-xs text-[#E36B11] font-medium">Part-time · Remote</span>
            </div>
          </div>
        </div>
