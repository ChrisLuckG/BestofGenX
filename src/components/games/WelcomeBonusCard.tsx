    ...
    >
      ...
      <div className={`flex-1 w-full border overflow-hidden flex flex-col relative min-h-0 transition-all duration-500 ${claimed ? 'border-green-500/50' : 'border-white/20'}`} style={{ backgroundColor: '#0a0a0a' }}>
        ...
        <div className="relative z-10 px-4 pt-3 flex items-center justify-between shrink-0">
          ...
          <div className={`flex items-center gap-2 px-3 py-1 border transition-all duration-500 ${claimed ? 'bg-green-500/10 border-green-500/30' : 'bg-black/40 border-white/20'}`}>
            <span className={`text-[10px] uppercase tracking-[0.2em] transition-colors duration-500 ${claimed ? 'text-green-400' : 'text-[#D4873A]'}`}>Bonus</span>
          </div>
        </div>
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 py-1 min-h-0 overflow-hidden">
          ...
          <h1 className={`font-display text-[44px] leading-[0.9] text-center mb-2 shrink-0 transition-colors duration-500 tracking-wide ${claimed ? 'text-green-400' : 'text-[#D4873A]'}`}>
            DAILY<br />CHALLENGE
          </h1>
          ...
          <div className="w-full max-w-[300px] border border-white/20 bg-black/40 backdrop-blur-md p-3 mb-3 shrink-0">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                <Zap className={`w-4 h-4 shrink-0 transition-colors duration-500 ${claimed ? 'text-green-400' : 'text-[#D4873A]'}`} />
          ...
          {!claimed ? (
            ...
            >
              <div className="border-2 border-[#D4873A] bg-[#D4873A]/10 px-6 py-2 transition-all active:bg-[#D4873A]/20 active:scale-[0.98]">
                <p className="text-[8px] uppercase tracking-[0.25em] text-[#D4873A] text-center mb-0.5">Tap to claim</p>
                <p className="font-display text-[32px] leading-none text-[#D4873A] text-center">
        ...
        {claimed ? (
          <div className="flex flex-col items-center animate-bounce">
            <div className="flex flex-col items-center" style={{ animation: 'pulse 1.5s ease-in-out infinite' }}>
              <ChevronUp className="w-7 h-7 text-[#D4873A]" />
              <ChevronUp className="w-7 h-7 -mt-5 text-[#D4873A]/70" />
            </div>
            <span className="text-[11px] uppercase tracking-[0.25em] mt-1 text-[#D4873A] font-medium">Swipe up to begin</span>
          </div>
        ) : (
          <div className="flex flex-col items-center text-[#D4873A] animate-pulse">
