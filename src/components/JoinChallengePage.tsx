...
const dailyPrizes = [
  { place: "1ST", label: "DAILY", value: "50€", img: "/images/genxlogo1.png", color: "#E36B11", textColor: "text-[#E36B11]", border: "border-[#E36B11]/40", glow: "shadow-[#E36B11]/20" },
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-3 pt-4 pb-3 border-b border-white/10 flex-shrink-0">
        <button onClick={onClose} className="flex items-center gap-2 text-white hover:text-[#E36B11] transition-colors">
      ...
      >
        ...
        <div className="relative px-4 pt-2 pb-6 text-center">
          <p className="text-[#E36B11] text-[10px] font-bold tracking-[0.3em] mb-2">BEST OF GENX</p>
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            {onOpenShop && (
              <button
                ...
                className="text-[#E36B11] text-[10px] font-bold tracking-wider hover:text-[#e8ff1a] transition-colors"
              >
                FROM OUR SHOP →
              </button>
            )}
              ...
              <div className="relative">
                <div className="aspect-square bg-cream/5 flex items-center justify-center relative">
                  ...
                  <div className="absolute top-2 right-2">
                    <div className="bg-[#E36B11] w-6 h-6 flex items-center justify-center">
        ...
        <div className="px-4 mb-6 space-y-3">
          ...
          {/* Annual */}
          <div className="border border-[#E36B11]/20 p-4 flex items-center gap-4" style={{ background: 'linear-gradient(135deg, rgba(212,240,0,0.08) 0%, rgba(0,0,0,0.5) 100%)' }}>
            <div className="w-16 h-16 border border-[#E36B11]/30 flex items-center justify-center flex-shrink-0 relative overflow-hidden" style={{ background: 'rgba(212,240,0,0.1)' }}>
            ...
            <div className="flex-1">
              <p className="text-[#E36B11] text-[9px] tracking-widest font-bold">ANNUAL WINNER</p>
              <p className="text-white font-black text-xl">5.000€</p>
              <p className="text-white/40 text-[10px]">+ 2.500€ 2nd · 1.000€ 3rd</p>
            </div>
            <Lock className="w-4 h-4 text-[#E36B11]/40" />
          </div>
        </div>

        {/* Stats bar */}
        <div className="px-4 mb-6">
          <div className="flex overflow-hidden border border-[#E36B11]/20">
        ...
        <div className="px-4 pb-8 space-y-3">
          <button
            ...
            style={{ background: '#E36B11', boxShadow: '0 8px 30px rgba(212,240,0,0.35)' }}
          >
            <span>SIGN UP</span>
          ...
          <button
            onClick={() => onShowLogin?.()}
            className="w-full py-4 font-bold text-white text-base transition-all active:scale-95 border border-[#E36B11]/30 bg-[#E36B11]/10 hover:bg-[#E36B11]/20"
          >
            SIGN IN
          </button>
        </div>
